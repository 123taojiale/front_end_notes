...
```
Lodash 是一个拓展了 JavaScript 内置对象方法的一个工具库

没啥好记录的

以下的 JavaScript 代码是老师上课中所介绍的一些方法 应该是该工具库中的一些比较常用的方法

如果要学习 Lodash 的话 还是直接看 "Lodash 中文文档" 吧...
```
...
console.log(_.differenceWith(objects, [{
    'x': 1,
    'y': 2
}], _.isEqual)); //[{ 'x': 2, 'y': 1 }]
```
